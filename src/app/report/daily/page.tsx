      ...
      <CardContent>
        <div ref={containerRef} className="relative bg-gradient-to-br from-slate-50 to-white rounded-xl p-6 border border-slate-100">
          ...
          >
            ...
            {/* X-axis labels */}
            {data.filter((_, index) => index % 4 === 0).map((dataPoint, index) => {
              const originalIndex = index * 4
              return (
                <text
                  key={index}
                  x={40 + (originalIndex / (data.length - 1)) * chartWidth}
                  y={chartHeight + 45}
                  textAnchor="middle"
                  className="text-xs fill-slate-600 font-medium"
                >
                  {`${originalIndex.toString().padStart(2, '0')}:00`}
                </text>
              )
            })}
          </svg>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      >
        <div className="flex items-start justify-between mb-4">
          <div>
            <div className="text-3xl font-bold text-blue-600 mb-1">{highlights.totalFocusTime.time}</div>
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="font-semibold text-blue-700">{highlights.totalFocusTime.goalProgress}%</span>
          </div>
          ...
          <div className="flex items-center justify-between text-xs text-blue-600">
            ...
            <div className="flex items-center gap-1">
              ...
              <span>+{highlights.totalFocusTime.weekTrend}%</span>
            </div>
          </div>
        </div>
      ...
      >
        <div className="flex items-start justify-between mb-4">
          <div>
            <div className="text-3xl font-bold text-emerald-600 mb-1">{highlights.averageFocus.score}</div>
            <div className="text-sm font-medium text-emerald-700">평균 집중도</div>
          </div>
          <div className="relative">
            <CircularProgress value={highlights.averageFocus.score} max={100} color="#10B981" size={64} strokeWidth={6} />
          </div>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between text-xs text-emerald-600">
            ...
            <div className="flex items-center gap-1">
              <TrendingUp className="w-3 h-3" />
              <span>+{highlights.averageFocus.sessionImprovement}점</span>
            </div>
          </div>
        </div>
      ...
      >
        <div className="flex items-start justify-between mb-4">
          <div>
            <div className="text-3xl font-bold text-orange-600 mb-1">{highlights.distractions.count}</div>
            <div className="text-sm font-medium text-orange-700">방해 요소</div>
          </div>
          <div className="flex flex-col items-center gap-2">
            <PulseIndicator count={highlights.distractions.count} color="#F59E0B" size={10} />
          </div>
        </div>
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="text-xs text-orange-700 bg-orange-100 px-2 py-1 rounded-full">
              {highlights.distractions.mainCause}
            </span>
          </div>

          <div className="space-y-2">
            {highlights.distractions.details.map((detail: any, index: number) => (
          ...
          <div className="flex items-center justify-between text-xs text-orange-600">
            ...
            <div className="flex items-center gap-1">
              ...
              <span>{highlights.distractions.yesterdayChange}회</span>
            </div>
          </div>
        </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/20">
      ...
      <main className="container mx-auto px-6 py-8">
        ...
        >
                ...
                <TabsContent value="overview" className="mt-6">
                  <div className="space-y-6">
                    <div>
                      ...
                      <TimelineCard data={mockFocusScorePoints} />
                    </div>
                  </div>
                </TabsContent>
          ...
          {/* Highlight Cards */}
          <HighlightCards highlights={mockHighlights} />
