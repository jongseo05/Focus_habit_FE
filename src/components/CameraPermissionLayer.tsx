...
import { Camera, AlertTriangle, RefreshCw, Settings, X, CheckCircle, ExternalLink } from "lucide-react"
import { Button } from "@/components/ui/button"
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card"
import { Alert, AlertDescription } from "@/components/ui/alert"
import { Badge } from "@/components/ui/badge"

interface CameraPermissionLayerProps {
  isVisible: boolean
  isLoading: boolean
  error: string | null
            ...
            <Card className="border-0 shadow-2xl bg-white">
              <CardHeader className="relative text-center pb-4">
                ...
                <p className="text-sm text-slate-600 mt-2">
                  집중도 모니터링을 위해 카메라 접근 권한을 허용해주세요
                </p>
              </CardHeader>
                    ...
                    {(error.toLowerCase().includes('다른 애플리케이션') || 
                      ...
                      <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                        ...
                        <ul className="text-sm text-blue-700 space-y-1 pl-4">
                          ...
                          <li>• 다른 브라우저 탭에서 카메라를 사용하는 사이트를 닫으세요</li>
                          <li>• 카메라를 사용하는 다른 프로그램을 종료하세요</li>
                  ...
                  <div className="space-y-3">
                    <Alert className="border-orange-200 bg-orange-50">
                      ...
                      <AlertDescription className="text-orange-700 text-sm">
                        브라우저 설정에서 카메라 권한을 수동으로 허용해야 합니다.
                      </AlertDescription>
                    </Alert>
                ...
                <div className="space-y-3 pt-4">
                  {!isPermissionGranted && (
                    ...
                    >
                      ...
                      {isLoading ? "권한 확인 중..." : isPermissionDenied ? "다시 시도" : "카메라 권한 허용"}
                    </Button>
                  )}
                  ...
                  <div className="bg-slate-50 rounded-lg p-3">
                    <div className="flex items-start gap-2">
                      ...
                      <p className="text-xs text-slate-600 leading-relaxed">
                        카메라는 집중도 분석에만 사용되며, 영상은 저장되지 않습니다. 
                        언제든지 권한을 취소하거나 카메라를 끌 수 있습니다.
                      </p>
                    </div>
                  </div>
                </div>
...
export default CameraPermissionLayer
